...
<dl class="form">
  ...
  ${h.form_input_text('site_copyright', _('Copyright string'), settings['site_copyright'], errors,\
    help=_('A string displayed at the bottom of each blog page, just before "Powered by Pyrone"'))|n}
  ...
  ${h.form_input_text('google_analytics_id', _('Google Analytics(tm) ID'), settings['google_analytics_id'], errors,\
