...
all dependencies too):
    ...
    $ easy_install-3.4 pyrone-1.4.0.tar.gz

Now prepare the application configuration files:

   $ cd /home/blog/pyrone-blog/
   $ cp ./env/lib/python3.4/site-packages/pyrone-1.4.0-py3.4.egg/share/pyrone/examples/production.ini .
...
Now we need to setup the database, to do this execute the following command:
    ...
    $ cd /home/blog/pyrone-blog
    $ pyronedbinit --sample-data --sample-data-file=./env/lib/python3.4/site-packages/pyrone-1.4.0-py3.4.egg/share/pyrone/sample-data.json production.ini
...
Then create configuration file for the application:
    ...
    # cp /home/blog/pyrone-blog/env/lib/python3.4/site-packages/pyrone-1.4.0-py3.4.egg/share/pyrone/examples/pyrone-uwsgi.ini /etc/uwsgi/apps-available/
...
Then create nginx configuration file for Pyrone's site:
    ...
    # cp /home/blog/pyrone-blog/env/lib/python3.4/site-packages/pyrone-1.4.0-py3.4.egg/share/pyrone/examples/pyrone-blog-nginx-uwsgi.conf /etc/nginx/sites-available/
